...
负责本 Skill 所定义的 Godot Data Resource 能力边界，不负责其他 Skill 的专属实现。

# Description

负责 Godot Resource、配置数据、数据结构与运行时数据边界。

# Purpose

为 Agent 提供明确、可发现、可验证的 Godot Data Resource 能力边界。
...
当任务涉及 Godot Data Resource 时，先读取本 Skill，再根据 Workflow 执行与验证。
