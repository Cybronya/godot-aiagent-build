...
负责本 Skill 所定义的 Godot Character System 能力边界，不负责其他 Skill 的专属实现。

# Description

负责角色实体、角色状态、角色控制与角色相关系统边界。

# Purpose

为 Agent 提供明确、可发现、可验证的 Godot Character System 能力边界。
...
- 用户任务明确涉及 Godot Character System。
...
当任务涉及 Godot Character System 时，先读取本 Skill，再根据 Workflow 执行与验证。
