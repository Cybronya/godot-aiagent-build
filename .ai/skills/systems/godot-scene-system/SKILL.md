...
负责本 Skill 所定义的 Godot Scene System 能力边界，不负责其他 Skill 的专属实现。

# Description

负责 Godot Scene 结构、层级、实例化边界与场景组织规范。

# Purpose

为 Agent 提供明确、可发现、可验证的 Godot Scene System 能力边界。
...
当任务涉及 Godot Scene System 时，先读取本 Skill，再根据 Workflow 执行与验证。
