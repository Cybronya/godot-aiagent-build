...
负责本 Skill 所定义的 Godot Debug Testing 能力边界，不负责其他 Skill 的专属实现。
...
为 Agent 提供明确、可发现、可验证的 Godot Debug Testing 能力边界。
...
当任务涉及 Godot Debug Testing 时，先读取本 Skill，再根据 Workflow 执行与验证。
